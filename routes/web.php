...
Route::post('mostrarGraficasMensuales', 'ConsultasMensualesController@tablaMensual')->name('mostrarGraficasMensuales');
...
/*REPORTES*/
Route::get('descargarBitacora', 'bitacoraController@downloadExcel')->name('descargarBitacora');
//Descargar excel de embarazadas
Route::get('ExcelEmbarazadas', 'EmbarazadasController@downloadExcel')->name('descargarExcelEmbarazadas');
//Descargar excel de Planificadores
Route::get('ExcelPlanificadores', 'PlanificadoresController@downloadExcel')->name('descargarExcelPlanificadores');
//Descargar PDF de planificadores
Route::get('PDFPlanificadores', 'PlanificadoresController@downloadPDF')->name('descargarPDFPlanificadores');
//Descargar Excel de Consultas Mensuales
Route::get('descargarConsultasMensuales', 'ConsultasMensualesController@downloadExcel')->name('descargarConsultasMensuales');
/*FIN DE REPORTES*/
