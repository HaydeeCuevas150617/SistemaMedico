...
@section('Seccion')
<div class="left">
        <h3 class="display-4">Bitácora Diaria</h1>
            
</div>
<!--Input de búsqueda por fecha-->
<div class="large " >
    
    {!! Form::open(['route' => 'indexB','method' =>'GET','class' =>'right', 'role' =>'search'])!!}
...
<div class="large " >
        {!! Form::open(['route' => 'indexB','method' =>'GET', 'role' =>'search'])!!}
        <div class="form-group">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('addP')}}" enctype="multipart/form-data" class="form-horizontal">
                @csrf
            <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="matricula" placeholder="Matrícula"
                        value="{{old('matricula')}}" maxlength="10" size="10">
                </div>
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
            ...
            <!--    <td> $paciente->nombre_afeccion!!}</td> -->
                ...
                <td class="textCenter">
                    <a href="{{ route('showTratamiento',$paciente->id_paciente)}}"
                        class="btn btn-amarillo-ch fas fa-prescription-bottle-alt" title="Ver tratamiento"></a>
                </td> 
                @if (auth()->user()->rol_id == 1)
                <td>
                    <a href="{{ route('mostrarDatos',$paciente->id_paciente)}}"
...
@endif
        ...
        <div class="sticky-container">
                ...
                <br>
                    <li>
                        <a data-toggle="modal" data-target="#ventanaFlotanteFecha" >
...
<div class="modal fade" id="ventanaFlotanteFecha" role="dialog">
        <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                          <!--Form de nuevo registro-->
                      <form method="get" action="{{ route('descargarBitacora')}}" enctype="multipart/form-data" class="form-horizontal">
                          @csrf
                      <div class="box-body">
                      <div class="form-group">
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-12">
                                      ...
                                      <input type="date" class="form-control" name="fecha_descarga"
