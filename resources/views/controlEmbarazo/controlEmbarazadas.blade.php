...
@section('Seccion')
<div class="left">
        <h3 class="display-4">Control de Embarazadas</h1>
</div>
<!--Input de búsqueda por fecha-->
<div class="large " >
    {!! Form::open(['route' => 'indexEmbarazadas','method' =>'GET','class' =>'right', 'role' =>'search'])!!}
...
<div class="large" >
        {!! Form::open(['route' => 'indexEmbarazadas','method' =>'GET', 'role' =>'search'])!!}
        <div class="form-group">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('addEmbarazada')}}" enctype="multipart/form-data" class="form-horizontal">
                @csrf
            <div class="box-body">
            <div class="form-group">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label"><b>Fecha de Nacimiento</b></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                    <select  class="form-control" name="afeccion_id">
                                            @foreach($registrosAfecciones as $afeccion)
                                            <option value="{!!$afeccion->id_afeccion!!}">{!! $afeccion->nombre_afeccion!!}</option>
                                            @endforeach
                                    </select>
                            </div>
                    </div>
...
@if ($registrosEmbarazadas->isEmpty()) <!--Si registrosEmbarazadas está vacío entonces...-->
...
<div class="box">
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
            ...
            @foreach($registrosEmbarazadas as $paciente) <!--Ciclo que recorre toda la tabla -->
            <tr class="textCenter">
                ...
                <td>
                    <a href="{{ route('showDatosExtra',$paciente->id_paciente)}}" role="button" 
                    class="btn btn-morado fas fa-file-medical-alt" title="Datos de Embarazo"></a>   
                </td>
                @if (auth()->user()->rol_id == 1)
                <td>
...
<div class="modal fade" id="ventanaFlotanteFechaExcel" role="dialog">
        <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                      <h4 class="modal-title fas fa-download"> Año de descarga</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>
                  <div class="modal-body">
                          <!--Form de nuevo registro-->
                      <form method="get" action="{{ route('descargarExcelEmbarazadas')}}" enctype="multipart/form-data" class="form-horizontal">
                          @csrf
                      <div class="box-body">
                      <div class="form-group">
                              <div class="form-group">
                                  <label class="col-sm-5 control-label"><b>Año de descarga:</b></label>
                                  <div class="col-sm-12">
                                      {!!$errors->first('anio_descarga','<br><span class="help-block">:message</span>')!!}
                                      <input type="number" class="form-control" name="anio_descarga"
                                          value="{{old('anio_descarga')}}">
                                  </div>
                              </div>
                              <div class="box-footer">
