...
@section('Seccion')
<div class="left">
        <h3 class="display-4">Planificación Familiar</h1>
</div>
<!--Input de búsqueda por fecha-->
<div class="large " >
    {!! Form::open(['route' => 'indexPlanificacion','method' =>'GET','class' =>'right', 'role' =>'search'])!!}
...
<div class="large" >
        {!! Form::open(['route' => 'indexPlanificacion','method' =>'GET', 'role' =>'search'])!!}
        <div class="form-group">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('addPlanificador')}}" enctype="multipart/form-data" class="form-horizontal">
                @csrf
            <div class="box-body">
            <div class="form-group">
                ...
                <div class="box-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                    <select readonly class="form-control" name="afeccion_id">
                                            <option value="10">10 .- Planificación Familiar</option>
                                    </select>
                            </div>
                    </div>
...
@if ($registrosPlanificador->isEmpty()) <!--Si registrosPlanificador está vacío entonces...-->
...
<div class="box">
    ...
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover">
            ...
            @foreach($registrosPlanificador as $paciente) <!--Ciclo que recorre toda la tabla -->
            <tr class="textCenter">
                ...
                <td>
                        <a href="{{ route('showDatosPlanificacion',$paciente->id_paciente)}}" role="button" 
                        class="btn btn-morado fas fa-hand-holding-heart" title="Datos de Planificación"></a>
...
<div class="modal fade" id="ventanaFlotanteFechaExcel" role="dialog">
    <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title fas fa-download"> Fecha de Descarga</h4>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
              </div>
              <div class="modal-body">
                      <!--Form de nuevo registro-->
                  <form method="get" action="{{ route('descargarExcelPlanificadores')}}" enctype="multipart/form-data" class="form-horizontal">
                      @csrf
                  <div class="box-body">
                  <div class="form-group">
                          <div class="form-group">
                              <label class="col-sm-6 control-label"><b>Fecha de Descarga:</b></label>
                              <div class="col-sm-12">
                                  {!!$errors->first('fecha','<br><span class="help-block">:message</span>')!!}
